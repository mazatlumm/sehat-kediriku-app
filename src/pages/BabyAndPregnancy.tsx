...
import ButtonNavGlass from "../components/ButtonNavGlass";
...
export default function BabyAndPregnancy() {
            ...
            <VStack spacing={{ base: 6, md: 10 }} w="full" maxW="xl" textAlign="center">
                <Box>
                    ...
                    <Text fontSize={{ base: "lg", md: "xl" }} color={subHeadingColor}>
                        Dapatkan informasi lengkap seputar kesehatan ibu hamil dan balita Anda di sini.
                    </Text>
                </Box>
